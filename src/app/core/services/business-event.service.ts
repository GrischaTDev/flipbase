...
const EVENT_LABELS: Readonly<Record<string, string>> = {
  ...
  expense_updated: 'Ausgabe geändert',
  expense_removed: 'Ausgabe entfernt',
  expense_restored: 'Ausgabe wiederhergestellt',
  expense_marked_paid: 'Ausgabe als bezahlt markiert',
  expense_marked_open: 'Ausgabe als offen markiert',
  expense_recurring_rule_created: 'Wiederholungsregel erstellt',
  expense_recurring_rule_updated: 'Wiederholungsregel geändert',
  expense_recurring_rule_removed: 'Wiederholungsregel entfernt',
  expense_document_added: 'Ausgabenbeleg hinzugefügt',
  expense_document_removed: 'Ausgabenbeleg entfernt',
