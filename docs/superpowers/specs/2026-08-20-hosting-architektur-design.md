# Hosting-Architektur: Flipbase und Wiehenstore
...
Die Domain `wiehenstore.de` wurde registriert. Zu klären war, wie Flipbase
...
| ----------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Shop und Flipbase trennen?          | **Ja, nach Domain getrennt**               | Flipbase ist das Werkzeug, Wiehenstore die Kundenmarke. Ein Shop braucht seine eigene Domain.                                                                                                                                                                                                                                                                                                                   |
...
│   ├── app.flipbase.de ....... Flipbase-Dashboard, noindex
│   └── wiehenstore.de ...... Shop (später, siehe offene Punkte)
│
├── flipbase-web .............. Angular-App hinter nginx, Container aus Phase 7
...
- Flipbase-Container gebaut und laufend, Gesundheitsprüfung grün
...
| 11  | Umbenennung Flipbase -> Flipbase im Code (Kosmetik)                                                                                                                                                                                                                                                                                                                            | –                              |
