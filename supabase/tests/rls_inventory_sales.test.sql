...
insert into public.sale_cost_entries (
  id, workspace_id, sale_id, category, description, amount
) values
  (
    '84000000-0000-4000-8000-000000000090', :'owner_workspace_id'::uuid,
    '84000000-0000-4000-8000-000000000060', 'packaging', 'RLS owner packaging', 0.45
  ),
  (
    '84000000-0000-4000-8000-000000000091', :'foreign_workspace_id'::uuid,
    '84000000-0000-4000-8000-000000000061', 'other', 'RLS foreign other cost', 1.25
  );
...
select is((select count(*) from pg_class where oid = 'public.sale_cost_entries'::regclass and relrowsecurity), 1::bigint, 'sale_cost_entries hat RLS aktiviert');
set local role authenticated;
set local request.jwt.claim.sub = :'owner_user_id';
...
set local role anon;
set local request.jwt.claim.sub = '';
select throws_ok($$select * from public.sale_cost_entries where id = '84000000-0000-4000-8000-000000000090'$$, '42501', null, 'anon kann keine Verkaufs-Kostenzeile lesen');
reset role;
