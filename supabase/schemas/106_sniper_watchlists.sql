...
create index idx_sniper_listings_watchlist_pending_global on public.sniper_listings(first_seen_at desc, id desc)
    where watchlist_evaluated_at is null;
...
-- Bewertet paketweise ausstehende Angebote unabhaengig von Vinted-Abfragen.
