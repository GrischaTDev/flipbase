...
-- Alte Webclients koennen waehrend des Rollouts noch die achtteilige Funktion
-- aufrufen. Sie darf nur noch reine Markenfilter weiterreichen und kann keine
-- Kategorie, Suche oder Preisgrenze mehr anlegen.
create or replace function public.upsert_sniper_query(
    p_id uuid,
    p_search_text text,
