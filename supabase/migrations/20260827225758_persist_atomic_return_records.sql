...
DROP FUNCTION public.record_sale_return(p_workspace_id uuid, p_sale_id uuid, p_refund_amount numeric, p_restock boolean, p_reason text, p_notes text);
...
GRANT ALL ON FUNCTION public.record_sale_return(uuid, uuid, numeric, boolean, text, text, text, text) TO authenticated;

GRANT ALL ON FUNCTION public.record_sale_return(uuid, uuid, numeric, boolean, text, text, text, text) TO service_role;
