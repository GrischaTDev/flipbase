-- Vereinheitlicht den Wareneingang, ergänzt Produktmerkmale und ermöglicht
-- das kontrollierte Ersetzen oder Entfernen verwendeter Marken.
-- Betroffen: public.purchases, public.purchase_lines, public.catalog_products,
-- public.inventory_items und public.brands.
...
create index idx_catalog_products_workspace_sku
  on public.catalog_products (workspace_id, sku)
  where sku is not null;

create function public.replace_and_delete_brand(
  p_workspace_id uuid,
  p_brand_id uuid,
