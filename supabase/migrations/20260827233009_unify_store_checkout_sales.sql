...
ALTER TABLE public.store_order_items
  ADD CONSTRAINT store_order_items_catalog_product_id_fkey FOREIGN KEY (catalog_product_id) REFERENCES public.catalog_products(id) ON DELETE SET NULL;

ALTER TABLE public.store_order_items
  ADD CONSTRAINT store_order_items_check CHECK (num_nonnulls(catalog_product_id, inventory_item_id) = 1);

CREATE INDEX idx_store_order_items_catalog_product_id ON public.store_order_items (catalog_product_id);