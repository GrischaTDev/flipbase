-- Purpose: Record store checkout shipping charges as buyer revenue instead of seller costs.
-- Affected: public.place_store_order and sales created from store orders.
