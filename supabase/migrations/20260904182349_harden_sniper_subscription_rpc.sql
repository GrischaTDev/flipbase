...
ALTER TABLE public.sniper_queries
  ADD CONSTRAINT sniper_queries_price_from_check CHECK (price_from IS NULL OR price_from >= 0::numeric);

ALTER TABLE public.sniper_queries
  ADD CONSTRAINT sniper_queries_price_to_check CHECK (price_to IS NULL OR price_to >= 0::numeric);